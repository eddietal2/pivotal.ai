...
export default function NewsArticleCard({ article }: { article: NewsArticle }) {
  ...
  return (
    <article className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-lg shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <a href="#" className="text-indigo-600 dark:text-indigo-300 font-bold">{article.ticker}</a>
