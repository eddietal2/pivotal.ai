              ...
              <div className="flex-1 flex flex-col justify-start items-center pt-6 pb-8 px-8 overflow-y-auto w-full max-h-screen" style={{ WebkitOverflowScrolling: 'touch' }}>
                <div className="space-y-6 w-full max-w-2xl mx-auto">
                  ...
                  <div className="text-center mt-2">
                    <span data-testid="chart-modal-timeframe-pill" title={`Last ${modalChartTimeframe}`} className="inline-flex items-center px-2 py-0.5 text-xs font-semibold rounded-full bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-700">
                      {humanTimeframeLabel(modalChartTimeframe)}
                    </span>
                  </div>
